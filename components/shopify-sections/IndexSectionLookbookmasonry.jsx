// components/shopify-sections/IndexSectionLookbookmasonry.jsx
// Converted from Shopify section: index-section-lookbookmasonry

'use client';
import Image from 'next/image';

export default function IndexSectionLookbookmasonry({ settings, data }) {
...
<div className="{item.top_offset == 'none' && (nomargin {% elsif item.top_offset == 'small' %}tt-offset-small )}container-indent">
  <div className="container{item.fullwidth && (-fluid)}" data-sectionname="index_sectionlookbookmasonry">
    ...
    <div className="tt-lookbook-masonry">
      <div className="tt-lookbook-init tt-grid-col-3 tt-add-item">

// components/shopify-sections/FooterTemplate.jsx
// Converted from Shopify section: footer-template

'use client';
import Image from 'next/image';

export default function FooterTemplate({ settings, data }) {
  // Settings from Shopify:
  // Top Offset. Only for index page: select
  // Top Offset: select
  // Fullwidth size: checkbox
  // undefined: header
  // Show top footer line: checkbox
  // Top line size: range
  // Desktop .Top footer line offset from footer content: text
  // Mobile .Top footer line offset from footer content: text
  // Footer top line color: color
  // undefined: header
  // Show logo: checkbox
  // Logo text: text
  ...
  // undefined: header
  // Copyright: textarea
  // Create grid 6/6 for copyright and payment icons: checkbox
...
{%- if block.type == 'footer_links' -%}{%- assign footer_links = block -%}{%- assign flp = forloop.index -%}{%- endif -%}
{%- if block.type == 'footer_links_des2' -%}{%- assign footer_links_2 = block -%}{%- assign flp2 = forloop.index -%}{%- endif -%}
{%- endfor -%}

<footer className="for-footer-blocks {template == 'index' && ( {item.top_offset}{% else %} {item.top_offset_normal})}">

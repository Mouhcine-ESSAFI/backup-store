// components/shopify-sections/IndexSectionBlurbs.jsx
// Converted from Shopify section: index-section-blurbs

'use client';
import Image from 'next/image';

export default function IndexSectionBlurbs({ settings, data }) {
...
<div className="{item.top_offset == 'none' && (nomargin {% elsif item.top_offset == 'small' %}tt-offset-small )}container-indent blurbssection{section.id}" data-sectionname="index_blurbssection">
